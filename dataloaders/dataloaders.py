...
def get_dataloader(args):
    ...
    if args.dataset == "cifar10":
        ...
        train_ds = torchvision.datasets.ImageFolder(root=traindir, transform=train_transform)
        validate_ds = torchvision.datasets.ImageFolder(root=validatedir, transform=test_transform)
        test_ds = torchvision.datasets.ImageFolder(root=testdir, transform=test_transform)
        args.num_classes = 10                                               
    else:
...
def get_transform(args):
    if args.dataset in ["cifar10", "cifar100", "svhn", "cinic10"]:
        ...
        if args.dataset == "cifar10":
            ...
            args.mean, args.std = [0.47889522, 0.47227842, 0.43047404], [0.24205776, 0.23828046, 0.25874835]  
